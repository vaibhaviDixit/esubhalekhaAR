...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
    <h1 class="h2">Smart Cards</h1>
    
    <div class="text-end"><a class="btn btn-primary btn-sm" href="<?php echo route('addSmartCard'); ?>?back=dashboard">
            Add Smart Card <i class="bi bi-plus-circle"></i></a></div>
                    ...
                    <tr>
                        <td>
                             <a class="btn btn-sm btn-primary  action-btn"
                                href="<?php echo route('addSmartCard/'.$card['cardID']); ?>?back=dashboard"
